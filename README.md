...
├── Flask/
│   ├── app.py
│   ├── crop_recommendation_model.pkl   # generated by the notebook
│   ├── scaler.pkl                      # generated by the notebook
│   └── templates/
│       ├── opticrop_landing.html
│       ├── opticrop_predict.html
│       └── opticrop_result.html
│
├── requirements.txt
└── README.md
```
